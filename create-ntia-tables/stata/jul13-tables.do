...
global isPersonVars "desktopUser laptopUser tabletUser mobilePhoneUser tvBoxUser pcOrTabletUser homeInternetUser workInternetUser schoolInternetUser altHomeInternetUser internetUser"
global isAdultVars "desktopUser laptopUser tabletUser mobilePhoneUser tvBoxUser pcOrTabletUser homeInternetUser workInternetUser schoolInternetUser altHomeInternetUser internetUser"
...
global internetAtHomeVars "internetAnywhere internetAtHome speedMostImportant reliabilityMostImportant affordabilityMostImportant serviceMostImportant mobilityMostImportant dataCapMostImportant mobileAtHome wiredHighSpeedAtHome satelliteAtHome dialUpAtHome ispBundle"
...
global adultInternetUserVars "emailUser textIMUser videoUser locationServicesUser teleworkUser jobSearchUser financeUser eCommerceUser healthInfoUser healthRecordsUser"
...
generate dataCapMostImportant = (hesci17 == 6) if isHouseholder
...
generate emailUser = (peprm35 == 1) if isRespondent & internetUser == 1 & isAdult
generate textIMUser = (peprm36 == 1) if isRespondent & internetUser == 1 & isAdult
generate videoUser = (peprm33 == 1) if isRespondent & internetUser == 1 & isAdult
generate locationServicesUser = (peprm313 == 1) if isRespondent & internetUser == 1 & isAdult
generate teleworkUser = (peprm37 == 1) if isRespondent & internetUser == 1 & isAdult
generate jobSearchUser = (peprm38 == 1) if isRespondent & internetUser == 1 & isAdult
generate financeUser = (peprm311 == 1) if isRespondent & internetUser == 1 & isAdult
generate eCommerceUser = (peprm312 == 1) if isRespondent & internetUser == 1 & isAdult
generate healthInfoUser = (peprm314 == 1) if isRespondent & internetUser == 1 & isAdult
generate healthRecordsUser = (peprm315 == 1 | peprm316 == 1) if isRespondent & internetUser == 1 & isAdult
