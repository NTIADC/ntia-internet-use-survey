...
global internetAtHomeVars "internetAnywhere internetAtHome homeSubPrivateISP homeSubPublicISP homeIncludedInternet homePublicFreeInternet wiredHighSpeedAtHome satelliteAtHome dialUpAtHome mobileDataPlan cableTVSubscription"
...
generate homeSubPrivateISP = (hehomsu == 1) if isHouseholder
generate homeSubPublicISP = (hehomsu == 2) if isHouseholder
generate homeIncludedInternet = (hehomsu == 3) if isHouseholder
generate homePublicFreeInternet = (hehomsu == 4) if isHouseholder
